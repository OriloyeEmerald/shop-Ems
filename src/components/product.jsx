...
const Product = ({product, id, isLoading, addToCart, removeFromCart, cart}) => {
    ...
    <div>
     ...
     :
      (
           ...
           <div className='mt-[1.5rem] border bg-white rounded-[.7rem] shadow-lg px-[1rem] py-[.8rem]' >
               ...
               {isProductInCart
                ? 
                <button className='border-[.15rem] rounded-[.4rem] border-red-900 py-[.2rem] px-[.4rem] text-white bg-red-900 ml-auto hover:bg-red-500 fade-in' onClick={() => removeFromCart(product, product.id)}>
                <p className='text-[1.1rem]'>remove</p>
               </button>
                :
                <button className='flex items-center gap-1 border-[.15rem] rounded-[.4rem] border-green-900 py-[.2rem] px-[.4rem] text-green-900 ml-auto hover:bg-green-100 fade-in' onClick={() => addToCart(product, 1)}>
